...
import "./JAGUARSPARMACRICKETCLUB.sol";

contract JAGUARSPARMACRICKETCLUBPreSale {
    JAGUARSPARMACRICKETCLUB public token;
    ...
    function JAGUARSPARMACRICKETCLUBPreSale(
        JAGUARSPARMACRICKETCLUB _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = JAGUARSPARMACRICKETCLUB(_token);
